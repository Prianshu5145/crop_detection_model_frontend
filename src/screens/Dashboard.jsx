  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="overflow-hidden">
        ...
        {!current ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            <div className="flex items-center gap-3">
              <div className="text-4xl">{getWeatherIcon(current.weathercode)}</div>
              <div>
      ...
      <Card>
        ...
        <PrimaryButton onClick={() => navigate("/mandi")}>
          Open Mandi →
        </PrimaryButton>
      </Card>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card>
          ...
          <PrimaryButton onClick={() => navigate("/finance")}>
            Open finance tools →
          </PrimaryButton>
        </Card>
        <Card>
          ...
          <PrimaryButton onClick={() => navigate("/advisory")}>
        ...
        <Card>
          ...
          <PrimaryButton onClick={() => navigate("/health")}>
            Open health centres →
          </PrimaryButton>
        </Card>
      </div>
